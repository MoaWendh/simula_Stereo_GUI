function fGeraTabelaEstatistica(pontos, estat, curvaAjustada, distanciaNominal, CalculaIncerteza_Y)
clc;
...
if CalculaIncerteza_Y
    ...
    colName= {'Dist. Nominal (m)', 'Dist. Sim (m)', 'DP direção X (mm)', 'DP direção Z (mm)'};
    distancia_L= estat.distancia_L; %*1000;
    distanciaNominal= distanciaNominal/1000;
    t1= table(distanciaNominal, distancia_L', estat.dp_L_X', estat.dp_L_Z');
    t1.Properties.VariableNames= colName;
    tabela= t1;  
